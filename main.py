...
invapi = InvenTreeAPI(INVENTREE_ADDRESS, username=INVENTREE_USERNAME, password=INVENTREE_PASSWORD)
...
response = dkapi.get_product_details_from_part_number(barcode)
